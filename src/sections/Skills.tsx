...
const skillLogos: Record<string, string> = {
  ...
  DNS: simpleIconUrl('cloudflare', 'F38020'),
  'Load Balancing': simpleIconUrl('nginx', '009639'),
  'Active Directory': simpleIconUrl('microsoft', '5E5E5E'),
  'Group Policy': simpleIconUrl('windows', '0078D4'),
  SSSD: simpleIconUrl('redhat', 'EE0000'),
  BeyondTrust: simpleIconUrl('beyondtrust', 'E87511'),
